	...
	<div class="features">
		...
		<article>
			...
			<div class="content">
				...
				<p></p>
					<li><a href="richa-bigallo.html" class="essaylink">Richa on the Bigallo</a></li>
			</div>
		</article>
		<article>
			<span class="icon fa-newspaper-o"></span>
			<div class="content">
				...
				<li>
					<a href="http://florenceasitwas.wlu.edu/paatz-bigallo.html" class="essaylink">Paatz on the Bigallo</a>
				</li>
				<li>
