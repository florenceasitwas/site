...
<ul>
{% assign var1 = site.art | where:"building","santa trinita" %}
{% for item in var1 %}
...
<ul>
{% assign var3 = site.culture | where:"building","santa trinita" | sort: 'title' %}
{% for item in var3 %}
  <li><a href="{{ item.url | absolute_url }}">{{item.title}}</a></li>
{% endfor %}
</ul>
...
<ul>
{% assign var2 = site.people | where:"building","santa trinita" %}
{% for item in var2 %}
  <li><a href="{{ item.url | absolute_url }}">{{item.title}}</a></li>
{% endfor %}
</ul>
...
<ul>
{% assign var1 = site.architecture | where:"building","santa trinita" %}
{% for item in var1 %}
  <li><a href="{{ item.url | absolute_url }}">{{item.title}}</a></li>
{% endfor %}
</ul>
